...
public class ListaDeGruposFragment extends Fragment implements AdaptadorDeGrupo.OnClickAdaptadorDeGrupo {
    ...
    public AdaptadorDeGrupo getAdaptador() {
        return adaptador;
    }

    public void setAdaptador(AdaptadorDeGrupo adaptador) {
        this.adaptador = adaptador;
    }

    public RecyclerView getListadoGrupos() {
        return listadoGrupos;
    }

    public void setListadoGrupos(RecyclerView listadoGrupos) {

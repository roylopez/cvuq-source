...
public class ListaInvestigadoresFragment extends Fragment implements AdaptadorDeInvestigador.OnClickAdaptadorDeInvestigador {
    ...
    public AdaptadorDeInvestigador getAdaptador() {
        return adaptador;
    }

    public void setAdaptador(AdaptadorDeInvestigador adaptador) {
        this.adaptador = adaptador;
    }

    public RecyclerView getListadoDeInvestigadores() {
        return listadoDeInvestigadores;
    }

    public void setListadoDeInvestigadores(RecyclerView listadoDeInvestigadores) {
        this.listadoDeInvestigadores = listadoDeInvestigadores;
    }

    public OnInvestigadorSeleccionadoListener getListener() {
        return listener;
    }

    public void setListener(OnInvestigadorSeleccionadoListener listener) {
